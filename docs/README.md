...
> [!NOTE] 
> _A Macro Generating Solution for MacroDroid for E-Wallet (GCash, Maya) Payment Automation_
> _A tool to automate E-Wallet payments (GCash, Maya)_
> _A Voucher Code Print-out Customizer for Omada Controllers_
