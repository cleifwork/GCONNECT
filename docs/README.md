...
> [!NOTE] 
> _A Macro Generating Solution for MacroDroid. A tool to automate E-Wallet payments (GCash, Maya). A WiFi Voucher Print-out Customizer for Omada Controllers_
