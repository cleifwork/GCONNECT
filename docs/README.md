...
> [!NOTE] 
> _A Macro Generating Solution for MacroDroid. A tool to automate E-Wallet payments (GCash, Maya). A WiFi Voucher Print-out Customizer for any voucher-capable controllers using the Omada Controller VoucherList Template_
- [Omada Controller VoucherList Template](https://web.facebook.com/groups/1776872022780742/permalink/1987421671725775)
